...
また、選択範囲が「親と子のフレームをまたぐ」あるいは「フレーム内の本文と入力フォームとをまたぐ」場合には、APIが完全な文字列を返してくれず、これもやむを得ず不正確な結果となることがあります。
...
- バージョン 2.4（※不具合修正版を公開申請中）
  - フォームへの入力文字数を表示する機能を追加
  - 自動計数モード時にアイコンにバッジを表示
  - 子フレーム内の文字を数えられない問題を解消
- バージョン 2.3
